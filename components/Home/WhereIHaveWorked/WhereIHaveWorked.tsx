...
import Machnet from "./Descriptions/Macnettechonology";
...
export default function WhereIHaveWorked() {
  ...
  const GetDescription = () => {
    switch (DescriptionJob) {
      case "Machnet Technology":
        return <Machnet />;
    }
  };
  const [DescriptionJob, setDescriptionJob] =
    React.useState("Machnet Technology");
  return (
    <div
      data-aos="fade-up"
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Machnet techonology"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="Machnet techonology"
